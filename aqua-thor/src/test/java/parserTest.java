...
public class parserTest extends Assert{
    ...
    public void domTest(){
        ...
        Fish fish1 = new Fish(15,15,2,4);
        fish1.setXCoord(3);
        fish1.setYCoord(5);
        fishes.add((IFish)fish1);
        Shark fish2 = new Shark(15,15,2,4);
        fish2.setXCoord(3);
        fish2.setYCoord(6);
